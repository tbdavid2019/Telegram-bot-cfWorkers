...
export async function generateCommandSystemPrompt(context) {
    ...
    prompt += '2. **📘 長文與產品/時事/教學深度整理自動推送 Wiki**：當用戶提到「透過 wiki 寫... / 撰寫 2000 字長文報導 / 白宮主導的戰爭整理 / 英語商務口說對話 / 產品文檔」，請直接撰寫高質量完整長文，並在第一輪輸出 `[CALL:/wiki {"slug":"...","title":"...","content":"完整Markdown長文"}]` 發布至 David888 Wiki。工具執行成功後，在 Telegram 中只提供簡短精要導讀，並附上專屬公開閱讀連結 (`shareUrl`)、簡報連結 (`/present`) 與電子書連結 (`/book`)，絕不要在 Telegram 重複印出萬字全文。\n';
